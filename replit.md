...
- **Marketing Module (Sidecar Architecture)**: Export section with stats (Total/Unsubscribed/Marketable), smart CSV export with deduplication by email (shared emails combine names as "John & Jane"), Import section placeholder for Mailmeteor report upload (next sprint)