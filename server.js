...
const SCHEMA = {
  'Opportunities': {
    ...
    fields: [
      ...
      { key: 'mc_DateUnconditionalOpp', label: 'Date Unconditional', type: 'long-text' },
      { key: 'mc_DateSettlement', label: 'Date Settlement', type: 'long-text' },
      { key: 'mc_DateSettlementOpp', label: 'Date Settlement (Opp)', type: 'long-text' },
      { key: 'mc_DateDeclinedOpp', label: 'Date Declined', type: 'long-text' },
      { key: 'mc_DateWithdrawnOpp', label: 'Date Withdrawn', type: 'long-text' },
      { key: 'ActualCloseDate', label: 'Actual Close Date', type: 'long-text' },
